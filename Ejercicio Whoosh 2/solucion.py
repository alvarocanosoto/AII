    ...
    for p in range(1,PAGINAS+1):
        ...
        for i in l:
            ...
            if t :#tienen alguna/s de las caracterÃ­sticas adicionales
                ...
                tematica = temcom.find("div", attrs={"data-th":"Tematica"})
                if tematica:
                ...
                jugadores = temcom.find("div",attrs={"data-th":"Nunmero de jugadores"})
                if jugadores:
                    jugadores = jugadores.string.strip()
                else:
                    jugadores = "Desconocida"
            else: #no tienen caracteri­sticas adicionales
                tematica = "Desconocida"
                complejidad = "Desconocida"
                jugadores="Desconocida"
...
def imprimir_lista(cursor):
    ...
    for row in cursor:
        ...
        lb.insert(END,"    Tematicas: "+ row['tematicas'])
...
def buscar_tematicas():
    ...
    v = Toplevel()
    v.title("Busqueda por Tematica")
    l = Label(v, text="Seleccione tematica a buscar:")
    l.pack(side=LEFT)
...
def buscar_precio():
    ...
    l = Label(v, text="Introduzca el precio maximo:")
    l.pack(side=LEFT)
    en = Entry(v)
    en.bind("<Return>", mostrar_lista)
    en.pack(side=LEFT)
...
def buscar_jugadores():
    ...
    l = Label(v, text="Introduzca el numero de jugadores:")
    l.pack(side=LEFT)
    en = Entry(v)
    en.bind("<Return>", mostrar_lista)
    en.pack(side=LEFT)
...
def ventana_principal():       
    ...
    buscarmenu.add_command(label="Tematicas", command=buscar_tematicas)
